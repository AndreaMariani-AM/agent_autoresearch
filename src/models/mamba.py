# Rearranged from here: https://github.com/isyangshu/MambaMIL/blob/main/mamba/mamba_ssm/modules/srmamba.py
import math
...
from utils.mamba_utils import selective_scan_fn, mamba_inner_fn_no_out_proj, selective_state_update
